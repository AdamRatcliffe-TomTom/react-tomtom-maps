...
declare module "@tomtom-international/web-sdk-maps" {
  namespace tt {
    ...
    export function map(options?: MapboxOptions): tt.Map;
    ...
    export class Map extends Evented {
      ...
      setGeopoliticalView(geopoliticalView: string): Promise<boolean>;

      getAttributionControl(): any;
      ...
      project(lnglat: LngLatLike): tt.Point;

      unproject(point: PointLike): tt.LngLat;
      ...
      addLayer(layer: tt.Layer, before?: string): this;

      moveLayer(id: string, beforeId?: string): this;

      removeLayer(id: string): this;

      getLayer(id: string): tt.Layer;
      ...
      setLight(options: tt.Light, lightOptions?: any): this;
      ...
      setCenter(center: LngLatLike, eventData?: tt.EventData): this;

      panBy(
        offset: PointLike,
        options?: tt.AnimationOptions,
      ...
      setZoom(zoom: number, eventData?: tt.EventData): this;
      ...
      zoomIn(options?: tt.AnimationOptions, eventData?: tt.EventData): this;

      zoomOut(options?: tt.AnimationOptions, eventData?: tt.EventData): this;

      getBearing(): number;

      setBearing(bearing: number, eventData?: tt.EventData): this;
      ...
      resetNorth(options?: tt.AnimationOptions, eventData?: tt.EventData): this;
      ...
      jumpTo(options: tt.CameraOptions, eventData?: tt.EventData): this;

      easeTo(options: tt.EaseToOptions, eventData?: tt.EventData): this;

      flyTo(options: tt.FlyToOptions, eventData?: tt.EventData): this;
    ...
    export interface MapboxOptions {
      ...
      fitBoundsOptions?: tt.FitBoundsOptions;
      ...
      /** The dictionary of options representing visibility of style parts */
    ...
    export class Popup extends Evented {
      constructor(options?: tt.PopupOptions);
    ...
    export class GeoJSONSource implements GeoJSONSourceRaw {
      ...
      constructor(options?: tt.GeoJSONSourceOptions);
    ...
    export class VideoSource implements VideoSourceRaw {
      ...
      constructor(options?: tt.VideoSourceOptions);
    ...
    export class ImageSource implements ImageSourceRaw {
      ...
      constructor(options?: tt.ImageSourceOptions);
    ...
    export class LngLat {
      ...
      static convert(input: LngLatLike): tt.LngLat;
    }
    ...
    export class LngLatBounds {
      ...
      extend(obj: tt.LngLat | tt.LngLatBounds): this;
      ...
      static convert(input: LngLatBoundsLike): tt.LngLatBounds;
    }
    ...
    export class Marker extends Evented {
      constructor(options?: tt.MarkerOptions);

      constructor(element?: HTMLElement, options?: tt.MarkerOptions);
    ...
    export interface FitBoundsOptions extends tt.FlyToOptions {
      linear?: boolean;

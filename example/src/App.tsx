...
const mapStyles = [
  {
    label: "Genesis - Basic Street Light",
    value: "genesis:2/basic_street-light",
    attribution: "Genesis"
  },
  {
    label: "Genesis - Basic Street Dark",
    value: "genesis:2/basic_street-dark",
    attribution: "Genesis"
  },
  {
    label: "Orbis - Basic Street Light",
    value: "orbis:basic_street-light",
    attribution: "Orbis"
  },
  {
    label: "Orbis - Basic Street Dark",
